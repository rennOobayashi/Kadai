...
namespace Week09Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            {
                cmbClass.Items.Add(Student.ClassName[(CLASS)i]);
            }
            ...
            departments[0]
                = new Department("A001", "컴퓨터정보");

            departments[1]
                = new Department("A002", "컴퓨터시스템");
        ...
        private void btnRegisterProfessor_Click(object sender, EventArgs e)
        {
            ...
            Professor professor = new Professor(dept.Code, tbxProfessorNumber.Text, tbxProfessorName.Text);
        ...
        private void RegisterStudent()
        {
            ...
            //if (false == int.TryParse(cmbYear.SelectedItem.ToString()
            //    , out student.Year)) {
            //    cmbYear.Focus();
            //    return;
            //}
            ...
            student.SetRegStatus(cmbRegStatus.SelectedIndex);
        ...
        private void UpdateStudent() //define
        {
            ...
            selectedStudent.SetRegStatus(cmbRegStatus.SelectedIndex);
